...
public class DummyMeetingGenerator {
    ...
    public static List<Meeting> DUMMY_MEETINGS = Arrays.asList(
            ...
            new Meeting(2, "Achat matériel", "C5", new Date(2020, 14, 7, 14, 0), "#0000FF", Arrays.asList(DUMMY_USERS.get(0), DUMMY_USERS.get(5), DUMMY_USERS.get(6))),
            new Meeting(3, "Point hebdomadaire", "A2", new Date(2020, 14, 11, 14, 0), "#FF0000",  DUMMY_USERS),
            new Meeting(4, "Acceuil nouvelle recrue", "A7", new Date(2020, 14, 12, 11, 0), "#FF0000",  Arrays.asList(DUMMY_USERS.get(1), DUMMY_USERS.get(3), DUMMY_USERS.get(4))),
            ...
            new Meeting(8, "Recrutement de personnel", "B9", new Date(2021, 1, 5, 14, 0), "#00FF00", Arrays.asList(DUMMY_USERS.get(0), DUMMY_USERS.get(1), DUMMY_USERS.get(3)))
    );
